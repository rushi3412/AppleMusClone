...
//         <div className="navbarthreedivs">
//           <div className="playstopicons">
//           {/* <IconButton className={isLooping ? 'loopbtn active' : 'loopbtn'} onClick={handleLoop}>
//           <Repeat />
//           </IconButton>
//           <IconButton className="prevbtn" onClick={handlePrev}>
//               <SkipPrevious />
//                </IconButton>
//                <IconButton className={isPlaying ? "pausebtn" : "playbtn"} onClick={handlePlayPause}>
//                 {isPlaying ? <Pause /> : <PlayArrow />}
//               </IconButton>

//             <IconButton className="forwardbtn" onClick={handleForward}>
//               <SkipNext />
//             </IconButton>
//             <IconButton className={isShuffling ? 'shufflebtn active' : 'shufflebtn'} onClick={handleShuffle}>
//               <Shuffle />
//             </IconButton> */}
//           </div>
