...
//   return (
//     <Drawer variant="permanent" anchor="left" style={sidebarStyle}>
//       <h1>Apple</h1>
//       <List>
//         <ListItem button>
//           <SearchBar onSearch={onSearch} /> {/* Pass 'onSearch' as the prop */}
//         </ListItem>
//         {/* <ListItem button>
...
//             </div>
//             <form className="sidebarinput">
//             <div className="search-label" onClick={handleSearchClick}>
//               <svg
//                 height="12"
//                 width="12"
//                 viewBox="0 0 16 16"
            ...
            <div className="sidebardetails">
              <div className="details">
                ...
                <svg
                 ...
                 <NavLink to="/ListenNow" activeClassName="active "
                  className="sidebar-btn">
                <p class= "button">Listen Now</p>
                </NavLink>
              </div>
              <div className="details">
                <svg
                ...
                <NavLink to="/browse" className="sidebar-btn">
              ...
              <div className="details">
                ...
                <NavLink to="/coming-soon" className="sidebar-btn"> 
                <p class= "button">Radio</p>
                </NavLink>
              </div>
              <div className="details" >
                <svg
                ...
                <NavLink to="/favorites" className="sidebar-btn">
                <p class= "button">Favorites</p>
                </NavLink>
              </div>
            </div>
          </div>
