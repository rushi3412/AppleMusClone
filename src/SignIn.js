...
//           <button onClick={handleSecondContinueClick} style={{ backgroundColor: '#E75480', width: '300px', height: "45px", borderRadius: '9px', fontSize: '18px' }}>Continue</button>
//         </>
//       ) : (
//         <div style={{ maxHeight: '650px', overflow: 'auto',  display: 'flex',
//                         flexDirection: 'column',
...
//           <button onClick={handleBackClick} style={{ backgroundColor: 'gray', width: '150px', height: "45px", borderRadius: '9px', fontSize: '18px', marginRight: '10px' }}>Back</button>
//           <button onClick={handleSecondContinueClick} style={{ backgroundColor: '#E75480', width: '150px', height: "45px", borderRadius: '9px', fontSize: '18px' }}>Continue</button>
//         </div>
//       )
//       }
//     </div>
...
const SignIn = () => {
  ...
  const getToken = () => {
    ...
    return { token: accessToken, userData: userData ? JSON.parse(userData) : null };
  };
