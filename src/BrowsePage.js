              ...
              <Card className="album-card custom-card">
                {index === 0 ? (
                  <>
                    <CardContent>
                      <div className="text-truncate">
                        <Typography variant="h5" component="div" className="album-title" style={{ fontSize: '13px', fontFamily: 'Arial, sans-serif' }}>
                          {album.title}
                        </Typography>
                      </div>
                      <div className="text-truncate">
                        <Typography variant="body2" color="textSecondary" className="song-title" style={{ fontSize: '16px', fontFamily: 'Arial, sans-serif' }}>
                          {album.artists[0].name}
                        </Typography>
                      </div>
                    </CardContent>
                  ...
                  <>
                    ...
                    <CardContent>
                      <div className="text-truncate">
                        <Typography variant="h5" component="div" className="album-title" style={{ fontSize: '14px', fontFamily: 'Arial, sans-serif' }}>
                          {album.title}
                        </Typography>
                      </div>
                      <div className="text-truncate">
                        <Typography variant="body2"  color="white" className="song-title" style={{ fontSize: '12px', fontFamily: 'Arial, sans-serif' }}>
                          {album.artists[0].name}
                        </Typography>
                      </div>
                    </CardContent>
